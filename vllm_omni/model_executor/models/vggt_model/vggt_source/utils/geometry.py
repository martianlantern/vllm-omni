...
from vllm_omni.model_executor.models.vggt_model.vggt_source.dependency.distortion import (
    apply_distortion,
...
def depth_to_world_coords_points(
    ...
    Args:
        ...
        extrinsic (np.ndarray): Camera extrinsic matrix of shape (3, 4). OpenCV camera coordinate convention,
                                cam from world.
