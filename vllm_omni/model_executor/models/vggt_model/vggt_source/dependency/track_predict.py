...
def predict_tracks(
    ...
    # from vllm_omni.model_executor.models.vggt_model.vggt_source.utils.visual_track import visualize_tracks_on_images
    # visualize_tracks_on_images(images[None], torch.from_numpy(pred_tracks[None]),
    #                            torch.from_numpy(pred_vis_scores[None])>0.2, out_dir="track_visuals")
